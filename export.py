...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/dust.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp12/weights/best.pt', help='weights path')
